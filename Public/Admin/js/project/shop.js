...
//添加店铺
  $('#shopAdd').click(function() {
    ...
    bodyHtml += '			<select class="form-control" name="cityId" id="shopCitySelectModal">';
    ...
    bodyHtml += '		<div class="col-sm-10">';
    bodyHtml += '			<input type="text" class="form-control" name="shopName" id="shopName" value="" max="32">';
    bodyHtml += '		</div>';
    bodyHtml += '	</div>';
    bodyHtml += '	<div class="form-group">';
    bodyHtml += '		<label class="col-sm-2 control-label">起送价</label>';
    bodyHtml += '		<div class="col-sm-10">';
    bodyHtml += '			<input type="text" class="form-control onlyDigitData" name="lowprice" id="lowprice" value="" max="32">';
    bodyHtml += '		</div>';
    bodyHtml += '	</div>';
    bodyHtml += '	<div class="form-group">';
    bodyHtml += '		<label class="col-sm-2 control-label">运费</label>';
    bodyHtml += '		<div class="col-sm-10">';
    bodyHtml += '			<input type="text" class="form-control onlyDigitData" name="shipCost" id="shipCost" value="" max="32">';
    bodyHtml += '		</div>';
    bodyHtml += '	</div>';
    bodyHtml += '	<div class="form-group">';
    bodyHtml += '		<label class="col-sm-2 control-label">地址</label>';
    bodyHtml += '		<div class="col-sm-10">';
    bodyHtml += '			<input type="text" class="form-control" name="address" id="address" value="" max="200">';
    bodyHtml += '		</div>';
    bodyHtml += '	</div>';
    bodyHtml += '	<div class="form-group">';
    ...
    bodyHtml += '				<input type="radio" name="shopType" value="1" checked><span>校园</span>';
    bodyHtml += '			</label>';
    bodyHtml += '			<label class="radio-inline">';
    bodyHtml += '				<input type="radio" name="shopType" value="2"><span>社区</span>';
    bodyHtml += '			</label>';
    bodyHtml += '			<label class="radio-inline">';
    bodyHtml += '				<input type="radio" name="shopType" value="3"><span>办公室</span>';
    bodyHtml += '			</label>';
    bodyHtml += '		</div>';
    bodyHtml += '	</div>';
    bodyHtml += '	<div class="form-group">';
    ...
    bodyHtml += '			<label class="radio-inline">';
    bodyHtml += '				<input type="radio" name="shopBusinessType" value="1" checked><span>门店模式</span>';
    bodyHtml += '			</label>';
    bodyHtml += '			<label class="radio-inline">';
    bodyHtml += '				<input type="radio" name="shopBusinessType" value="2"><span>快递模式</span>';
    bodyHtml += '			</label>';
    bodyHtml += '		</div>';
    bodyHtml += '	</div>';
    bodyHtml += '	<div class="form-group">';
    ...
    bodyHtml += '			<label class="radio-inline">';
    bodyHtml += '				<input type="radio" name="shopDeliverType" value="1"><span>自提</span>';
    bodyHtml += '			</label>';
    bodyHtml += '			<label class="radio-inline">';
    bodyHtml += '				<input type="radio" name="shopDeliverType" value="2" checked><span>送货上门</span>';
    bodyHtml += '			</label>';
    bodyHtml += '			<label class="radio-inline">';
    bodyHtml += '				<input type="radio" name="shopDeliverType" value="3"><span>两种方式都行</span>';
    bodyHtml += '			</label>';
    bodyHtml += '		</div>';
    bodyHtml += '	</div>';
    bodyHtml += '	<div class="form-group">';
    ...
    bodyHtml += '			<label class="radio-inline">';
    bodyHtml += '				<input type="radio" name="shopPayType" value="1" checked><span>在线支付</span>';
    bodyHtml += '			</label>';
    bodyHtml += '			<label class="radio-inline">';
    bodyHtml += '				<input type="radio" name="shopPayType" value="2"><span>货到付款</span>';
    bodyHtml += '			</label>';
    bodyHtml += '			<label class="radio-inline">';
    bodyHtml += '				<input type="radio" name="shopPayType" value="3"><span>两种方式都行</span>';
    bodyHtml += '			</label>';
    bodyHtml += '		</div>';
    bodyHtml += '	</div>';
    bodyHtml += '	<div class="form-group">';
    ...
    bodyHtml += '			<label class="radio-inline">';
    bodyHtml += '				<input type="radio" name="shopIsopen" value="0" checked><span>未营业</span>';
    bodyHtml += '			</label>';
    bodyHtml += '			<label class="radio-inline">';
    bodyHtml += '				<input type="radio" name="shopIsopen" value="3"><span>放假中</span>';
    bodyHtml += '			</label>';
    bodyHtml += '			<label class="radio-inline">';
    bodyHtml += '				<input type="radio" name="shopIsopen" value="1"><span>半开通</span>';
    bodyHtml += '			</label>';
    bodyHtml += '			<label class="radio-inline">';
    bodyHtml += '				<input type="radio" name="shopIsopen" value="2"><span>全开通</span>(<font color="red">选择全开通必须要有自提点</font>)';
    bodyHtml += '			</label>';
    bodyHtml += '		</div>';
    bodyHtml += '	</div>';
    bodyHtml += '	<div class="form-group">';
    ...
    bodyHtml += '			<input class="form-control onlyDigitData" type="text" id="longitude" name="longitude" placeholder="经度，如：127.14321" max="64" value="">';
    bodyHtml += '		</div>';
    bodyHtml += '	</div>';
    bodyHtml += '	<div class="form-group">';
    bodyHtml += '		<label class="col-sm-2 control-label">维度</label>';
    bodyHtml += '		<div class="col-sm-5">';
    bodyHtml += '			<input class="form-control onlyDigitData" type="text" id="latitude" name="latitude" placeholder="纬度，如：37.6454" max="64" value="">';
    bodyHtml += '		</div>';
    bodyHtml += '	</div>';
    bodyHtml += '</form>';
    ...
    $(document).on('click','#modal_main .modal-footer #submit',function(){
      ...
      var type = $("input[name='shopType']:checked");
      var businessType = $("input[name='shopBusinessType']:checked");
      var deliverType = $("input[name='shopDeliverType']:checked");
      var payType = $("input[name='shopPayType']:checked");
      var isopen = $("input[name='shopIsopen']:checked");
      ...
      if(DoIllegalValidate2(new Array(shopNameInput),'unique', new Array('shop/name-unique-check'))) return;
      var ajaxResult = DoAjaxPost('/iadmin.php/Shop/add',$('#modal_main form').serialize());
...
//	alert(shopDeliverTypeTd);return;
    ...
    bodyHtml += '		<label class="col-sm-2 control-label">所在城市</label>';
    bodyHtml += '		<div class="col-sm-10">';
    bodyHtml += '			<input type="text" class="form-control" value="'+shopCity+'" disabled>';
    bodyHtml += '		</div>';
    bodyHtml += '	</div>';
    bodyHtml += '	<div class="form-group">';
    bodyHtml += '		<label class="col-sm-2 control-label">店铺名称</label>';
    bodyHtml += '		<div class="col-sm-10">';
    bodyHtml += '			<input type="text" class="form-control" name="shopName" id="shopName" value="'+shopName+'" max="32">';
    bodyHtml += '		</div>';
    bodyHtml += '	</div>';
    bodyHtml += '	<div class="form-group">';
    bodyHtml += '		<label class="col-sm-2 control-label">起送价</label>';
    bodyHtml += '		<div class="col-sm-10">';
    bodyHtml += '			<input type="text" class="form-control onlyDigitData" name="lowprice" id="lowprice" value="'+lowprice+'" max="32">';
    bodyHtml += '		</div>';
    bodyHtml += '	</div>';
    bodyHtml += '	<div class="form-group">';
    bodyHtml += '		<label class="col-sm-2 control-label">运费</label>';
    bodyHtml += '		<div class="col-sm-10">';
    bodyHtml += '			<input type="text" class="form-control onlyDigitData" name="shipCost" id="shipCost" value="'+shopShipCost+'" max="32">';
    bodyHtml += '		</div>';
    bodyHtml += '	</div>';
    bodyHtml += '	<div class="form-group">';
    bodyHtml += '		<label class="col-sm-2 control-label">地址</label>';
    bodyHtml += '		<div class="col-sm-10">';
    bodyHtml += '			<input type="text" class="form-control" name="address" id="address" value="'+address+'" max="200">';
    bodyHtml += '		</div>';
    bodyHtml += '	</div>';
    bodyHtml += '	<div class="form-group">';
    bodyHtml += '		<label class="col-sm-2 control-label">类型</label>';
    bodyHtml += '		<div class="col-sm-10 shopType">';
    bodyHtml += '			<label class="radio-inline">';
    bodyHtml += '				<input type="radio" name="shopType" value="1"><span>校园</span>';
    bodyHtml += '			</label>';
    bodyHtml += '			<label class="radio-inline">';
    bodyHtml += '				<input type="radio" name="shopType" value="2"><span>社区</span>';
    bodyHtml += '			</label>';
    ...
    bodyHtml += '		<div class="col-sm-10 shopBusinessType">';
    bodyHtml += '			<label class="radio-inline">';
    bodyHtml += '				<input type="radio" name="shopBusinessType" value="1"><span>门店模式</span>';
    bodyHtml += '			</label>';
    bodyHtml += '			<label class="radio-inline">';
    bodyHtml += '				<input type="radio" name="shopBusinessType" value="2"><span>快递模式</span>';
    bodyHtml += '			</label>';
    ...
    bodyHtml += '			</label>';
    bodyHtml += '			<label class="radio-inline">';
    bodyHtml += '				<input type="radio" name="shopDeliverType" value="2"><span>送货上门</span>';
    bodyHtml += '			</label>';
    bodyHtml += '			<label class="radio-inline">';
    bodyHtml += '				<input type="radio" name="shopDeliverType" value="3"><span>两种方式都行</span>';
    bodyHtml += '			</label>';
    ...
    bodyHtml += '		<label class="col-sm-2 control-label">经度</label>';
    bodyHtml += '		<div class="col-sm-5">';
    bodyHtml += '			<input class="form-control onlyDigitData" type="text" id="longitude" name="longitude" placeholder="经度，如：127.14321" max="64" value="'+longitude+'">';
    bodyHtml += '		</div>';
    bodyHtml += '	</div>';
    bodyHtml += '	<div class="form-group">';
    bodyHtml += '		<label class="col-sm-2 control-label">维度</label>';
    bodyHtml += '		<div class="col-sm-5">';
    bodyHtml += '			<input class="form-control onlyDigitData" type="text" id="latitude" name="latitude" placeholder="纬度，如：37.6454" max="64" value="'+latitude+'">';
    bodyHtml += '		</div>';
    bodyHtml += '	</div>';
    bodyHtml += '</form>';
    ...
    $(document).on('click','#modal_main .modal-footer #submit',function(){
      ...
      if(DoIllegalValidate2(new Array(shopNameInput),'unique', new Array('shop/name-unique-check/'+shopIdInput.val()))) return;
      var ajaxResult = DoAjaxPost('/shop/edit',$('#modal_main form').serialize());
      if(ajaxResult['title'] == 'success'){
        $('#modal_main').modal('hide');
        window.location.href = window.location.href;
      }
...
//添加自提点
  $('#serviceSiteAdd').click(function() {
    ...
    bodyHtml += '		<div class="col-sm-9">';
    bodyHtml += '			<select class="form-control" name="cityId" id="cacheCitySelect">';
    ...
    bodyHtml += '		<div class="col-sm-9">';
    bodyHtml += '			<select class="form-control" name="shopId" id="cacheShopSelect">';
    bodyHtml += '				<option value="">请选择...</option>';
    bodyHtml += '			</select>';
    bodyHtml += '		</div>';
    bodyHtml += '	</div>';
    ...
    bodyHtml += '		<div class="col-sm-9">';
    bodyHtml += '			<input type="text" class="form-control" name="siteName" id="siteName" value="" max="32">';
    bodyHtml += '		</div>';
    bodyHtml += '	</div>';
    bodyHtml += '	<div class="form-group">';
    bodyHtml += '		<label class="col-sm-3 control-label">地址</label>';
    bodyHtml += '		<div class="col-sm-9">';
    bodyHtml += '			<input type="text" class="form-control" name="address" id="address" value="" max="255">';
    bodyHtml += '		</div>';
    bodyHtml += '	</div>';
    bodyHtml += '	<div class="form-group">';
    bodyHtml += '		<label class="col-sm-3 control-label">联系人</label>';
    bodyHtml += '		<div class="col-sm-9">';
    bodyHtml += '			<input type="text" class="form-control" name="contact" id="contact" value="" max="255">';
    bodyHtml += '		</div>';
    bodyHtml += '	</div>';
    bodyHtml += '	<div class="form-group">';
    bodyHtml += '		<label class="col-sm-3 control-label">电话</label>';
    bodyHtml += '		<div class="col-sm-9">';
    bodyHtml += '			<input type="text" class="form-control onlyDigitData" name="contact_mobile" id="contact_mobile" value="" max="32">';
    bodyHtml += '		</div>';
    bodyHtml += '	</div>';
    bodyHtml += '	<div class="form-group">';
    ...
    bodyHtml += '		<label class="col-sm-1 control-label">时</label>';
    bodyHtml += '		<div class="col-sm-3">';
    bodyHtml += '			<select class="form-control" name="endHour" id="endHour">';
    bodyHtml += 				selectHourTime();
    bodyHtml += '			</select>';
    bodyHtml += '		</div>';
    bodyHtml += '		<label class="col-sm-1 control-label">分</label>';
    ...
    bodyHtml += '			<label class="radio-inline">';
    bodyHtml += '				<input type="radio" name="status" value="1" checked><span>营业中√</span>';
    bodyHtml += '			</label>';
    bodyHtml += '			<label class="radio-inline">';
    bodyHtml += '				<input type="radio" name="status" value="0"><span>停用×</span>';
    bodyHtml += '			</label>';
    bodyHtml += '		</div>';
    bodyHtml += '	</div>';
    bodyHtml += '	<div class="form-group">';
    ...
    bodyHtml += '		<div class="col-sm-9">';
    bodyHtml += '			<input type="text" class="form-control onlyDigitData" name="longitude" id="longitude" value="" max="10">';
    bodyHtml += '		</div>';
    bodyHtml += '	</div>';
    bodyHtml += '	<div class="form-group">';
    bodyHtml += '		<label class="col-sm-3 control-label">维度</label>';
    bodyHtml += '		<div class="col-sm-9">';
    bodyHtml += '			<input type="text" class="form-control onlyDigitData" name="latitude" id="latitude" value="" max="10">';
    bodyHtml += '		</div>';
    bodyHtml += '	</div>';
    bodyHtml += '</form>';
    ...
    $(document).on('click','#modal_main .modal-footer #submit',function(){
      ...
      if(DoIllegalValidate2(new Array(siteNameInput),'unique', new Array('site/name-unique-check'))) return;
      var ajaxResult = DoAjaxPost('/site/add',$('#modal_main form').serialize());
      if(ajaxResult['title'] == 'success'){
        var data = ajaxResult['data'];
        ...
        currTr.find('.sTime').html(data['service_begin']+'<code>至</code>'+data['service_end']);
        currTr.find('.sTime').attr('begin',data['service_begin']);
        currTr.find('.sTime').attr('end',data['service_end']);
...
//修改自提点
  ...
  $(document).on('click',".serviceSiteEidt",function() {
    ...
    bodyHtml += '		<label class="col-sm-3 control-label">所在店铺</label>';
    bodyHtml += '		<div class="col-sm-9">';
    bodyHtml += '			<input type="text" class="form-control" value="'+sShop+'" disabled>';
    bodyHtml += '		</div>';
    bodyHtml += '	</div>';
    bodyHtml += '	<div class="form-group">';
    bodyHtml += '		<label class="col-sm-3 control-label">自提点名称</label>';
    bodyHtml += '		<div class="col-sm-9">';
    bodyHtml += '			<input type="text" class="form-control" name="siteName" id="siteName" value="'+sName+'" max="32">';
    bodyHtml += '		</div>';
    bodyHtml += '	</div>';
    bodyHtml += '	<div class="form-group">';
    bodyHtml += '		<label class="col-sm-3 control-label">地址</label>';
    bodyHtml += '		<div class="col-sm-9">';
    bodyHtml += '			<input type="text" class="form-control" name="address" id="address" value="'+sAddress+'" max="255">';
    bodyHtml += '		</div>';
    bodyHtml += '	</div>';
    bodyHtml += '	<div class="form-group">';
    bodyHtml += '		<label class="col-sm-3 control-label">联系人</label>';
    bodyHtml += '		<div class="col-sm-9">';
    bodyHtml += '			<input type="text" class="form-control" name="contact" id="contact" value="'+sContact+'" max="255">';
    bodyHtml += '		</div>';
    bodyHtml += '	</div>';
    bodyHtml += '	<div class="form-group">';
    bodyHtml += '		<label class="col-sm-3 control-label">电话</label>';
    bodyHtml += '		<div class="col-sm-9">';
    bodyHtml += '			<input type="text" class="form-control onlyDigitData" name="contact_mobile" id="contact_mobile" value="'+sMobile+'" max="32">';
    bodyHtml += '		</div>';
    bodyHtml += '	</div>';
    bodyHtml += '	<div class="form-group">';
    bodyHtml += '		<label class="col-sm-3 control-label">开始营业时间</label>';
    ...
    bodyHtml += '		<label class="col-sm-3 control-label">经度</label>';
    bodyHtml += '		<div class="col-sm-9">';
    bodyHtml += '			<input type="text" class="form-control onlyDigitData" name="longitude" id="longitude" value="'+longitude+'" max="10">';
    bodyHtml += '		</div>';
    bodyHtml += '	</div>';
    bodyHtml += '	<div class="form-group">';
    bodyHtml += '		<label class="col-sm-3 control-label">维度</label>';
    bodyHtml += '		<div class="col-sm-9">';
    bodyHtml += '			<input type="text" class="form-control onlyDigitData" name="latitude" id="latitude" value="'+latitude+'" max="10">';
    bodyHtml += '		</div>';
    bodyHtml += '	</div>';
    bodyHtml += '</form>';
    ...
    $(document).on('click','#modal_main .modal-footer #submit',function(){
      ...
      if(DoIllegalValidate2(new Array(siteNameInput),'unique', new Array('site/name-unique-check/'+serviceSiteIdInput.val()))) return;
      var ajaxResult = DoAjaxPost('/site/edit',$('#modal_main form').serialize());
      if(ajaxResult['title'] == 'success'){
