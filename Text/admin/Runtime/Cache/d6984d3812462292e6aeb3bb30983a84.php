...
<link rel="stylesheet" type="text/css" href="__CSS__/media.css?ver=<?php echo ($conf["site_cssver"]); ?>">
 ...
 <div id="info_detail">
 	<div class="container" id="news_detail">
        ...
        <p class="subtitle subtitle_info"><?php echo (date('Y-m-d',$post["ctime"])); ?> </p>
        <div id="news_content"><?php echo ($post["contents"]); ?></div>
		-->

		<!--格式输出demo-->
        <h3 class="new_title">领投羊林之瀚：一封P2P公司的内部邮件</h3>
        <p class="subtitle subtitle_info">2014-11-06  </a></p>		
        <div id="news_content">
