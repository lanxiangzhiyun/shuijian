  ...
  <div class="main">
    ...
    <div class="register_main">
      ...
      <div class="register_box">
        <div class="register_tittle">快速注册</div>
        <div class="register_input">
          <input type="text" class="RegisterValue RegisterCaptchaValue" type="text" name="username" placeholder="请输入您的手机号">
        </div>
        <div class="register_input register_code">
          <input class="RegisterValue" name="captcha" type="text" placeholder="短信验证码">
          <div class="RegisterCaptcha send_code">
            发送验证码<span class="RegisterCaptchaTime"></span>
          </div>
        </div>
        <div class="register_input"><input class="RegisterValue" type="password" name="password" placeholder="请设置密码"></div>
        <div class="register_input"><input class="RegisterValue" type="password" name="password_repeat" placeholder="请再次输入密码"></div>
        <div class="register_btn"><a class="RegisterSubmit" href="javascript:;">注册</a></div>
        <a href="/Login" class="register_go">现在登录</a>
      </div>
    </div>
    <script type="text/javascript">
      $(function(){
        Common.Captcha($('.RegisterCaptcha'),$('.RegisterCaptchaValue'),'register',function(data){
          $('.RegisterCaptcha').addClass('one');
          $('.RegisterCaptchaTime').html(data['time']);
          Common.Timer($('.RegisterCaptchaTime'));
        });
        $('.RegisterSubmit').click(function(event) {
          var data = Base.Form.serialize($('.RegisterValue'));
          Base.Http.ajax({
            url : '/Register/submit',
            data : data,
