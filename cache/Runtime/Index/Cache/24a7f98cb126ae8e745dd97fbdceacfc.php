...
<div class="wrap Wrap">
    ...
    <div class="navtop_box">
      <div class="user_info_bar">
        <div class="user_info_bar_icon HeaderUserBtn">
          <img src="/Public/Common/images/default_avatar.png" width="28px" height="28px">
        </div>
  ...
  <div class="main">
    ...
    <div class="customer_main">
      <!-- 个人资料 -->
      <div class="info_main">
        <div class="ctr_user_icon"><img src="/Public/Common/images/default_avatar.png"width="100px"></div>
        <div class="pt20">
          <table>
            <tr>
              <td>帐号：13564128227</td>
              <td>姓名：用户3ISGXT99</td>
            </tr>
            <tr>
              <td>性别：女</td>
              <td>手机号：13564128227</td>
            </tr>
          </table>
        </div>

        <div class="ctr_user_set">
          <a href="/Customer/info">帐号设置</a>
        </div>
      </div>
      <!-- 导航 -->
      <div class="customer_nav">
        <ul>
          <li><a href="/Customer/order" class="this">我的订单</a></li>
          <li><a href="/Customer/address">地址管理</a></li>
          <li><a href="/Customer/virtual">抵用金</a></li>
        </ul>
      </div>
      ...
      <div class="customer_order_list">
        <div class="customer_order_tittle">订单列表</div>

        <div class="customer_order_box ">
          <table>
            <thead class="or_tittle">
            <tr>
              <td class="or_id">订单编号：
                <a target="_blank" href="/Order/info?order_code=2015112677834674">2015112677834674</a>
              </td>
              <td>下单时间：2015-11-26 18:02:39</td>
              <td class="or_money">订单金额：<span>¥590.00</span></td>
              <td class="or_state">订单状态：<span>未处理</span></td>
              <td rowspan="2">
                <a href="/Order/info?order_code=2015112677834674" class="gopay_now">立即支付</a>
              </td>
              <td rowspan="2"><a target="_blank" href="/Order/info?order_code=2015112677834674" class="order_details">查看详情</a></td>
            </tr>
          ...
          <table class="or_list">
            <tbody><tr>
              <td class="or_list_tittle">商<br>品<br>信<br>息</td>
              <td>
                <table class="or_table">
                  <thead>
                  <tr>
                    <th><div>共1件产品</div></th>
                    <th><div>收货日期</div></th>
                  ...
                  <tr>
                    <td width="300">
                      <div class="i_icon"><img src="/Public/Common/images/product/product_02.png" width="88px"></div>
                      <div class="i_tittle">
                        轻断食果蔬汁											暖身款											（三天装）
                      </div>
                    </td>
          ...
          <table class="or_tittle_b">
            <tbody><tr>
              <td>姓名：daf</td>
              <td>电话：13564128552</td>
              <td colspan="2">地址：北京市 北京市 adfadf</td>
            </tr>
            </tbody></table>
        </div>
        <!-- <div class="order_list_old"><span>查看更多历史订单</span></div> -->
      </div>
    </div>
  </div>
  <div class="footer">
