...
<div class="main">
  ...
  <div class="full_main pb200">
    <div class="auto_main">
      ...
      <!-- 去支付 -->
      <div class="gopay mt40">
        <div class="gopay_box">
          <p class="gopay_info">您的订单已提交成功</p>
          <a class="gopay_btn" href="/Order/alipay?order_code=2015112677834674"></a>
          <a class="gopay_btn wechat_pay" href="/Order/wepay?order_code=2015112677834674"></a>
        </div>
      </div>
      <!-- 订单信息 -->
      <div class="order_details_list">
        <table width="100%" class="order_details_id">
          <tr>
            <td>订单编号：2015112677834674</td>
            <td>下单时间：2015-11-26 18:02:39</td>
            <td>订单金额:¥ 590.00</td>
            <td>订单状态：未处理</td>
          </tr>
        </table>
        <table class="details_box">
          <tr class="border_b">
            <th>订单信息</th>
            <td>
              <table>
          ...
          <tr class="border_b">
            <th>订购产品</th>
            <td>
              <table class="order_details_s">
                <tr>
                  <th><span>共2件商品</span></th>
                  <th><span>商品清单</span></th>
                  <th><span>收货日期</span></th>
                  <th><span>单价</span></th>
                  <th><span>数量</span></th>
                </tr>
                <tr>
                  <td><img src="/Public/Common/images/product/product_02.png" alt="" width="130"></td>
                  <td>
                    <p>
                      轻断食果蔬汁
                      暖身款
                      三天装									</p>
                    <p class="color_e">包含18瓶400ml鲜榨排毒果蔬汁以及保温包3个，保鲜冰袋3个</p>
                  </td>
                  <td>
                    <div>2015-12-16</div>
                    <div>2015-12-17</div>
            ...
            <td>
              <table width="100%;">
                <tr>
                  ...
                  <td class="details_gods">
                    <p>商品金额：￥ 590.00</p>
                    <p>配送金额：￥ 0.00</p>
                    <p>优惠金额：￥ 0.00</p>
                    <p class="color_r">使用抵用金：￥ 0.00</p>
                  </td>
                </tr>
                <tr>
                  <td colspan="2" class="details_all_gods">总计金额：<span>￥590.00</span></td>
                </tr>
              </table>
            </td>
          </tr>
      ...
      <div class="express mt20">
        ...
        <div class="mt5"><span style="color:red;">*</span>（高铁快运需复制运单号在第三方官网查询）</div>
      </div>
    </div>
  </div>
</div>
