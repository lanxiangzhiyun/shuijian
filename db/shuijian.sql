...
-- ----------------------------
INSERT INTO shuijian_admin VALUES ('1', 'admin', 'd41d8cd98f00b204e9800998ecf8427e', 'f@126.com', 'admin', '123456', '127.0.0.1', '112222233', '1452915769', '1', '21,6,5,3,2,20,19,18,17', '1', '0');
...
CREATE TABLE `shuijian_deliver` (
  ...
  `deliver_shop` int(3) default NULL,
  `deliver_apiCode` varchar(60) NOT NULL,
...
-- ----------------------------
INSERT INTO shuijian_deliver VALUES ('3', 'test3333888', '11111111111', '0', 'test');
...
-- ----------------------------
INSERT INTO shuijian_goods_category VALUES ('1', 'test', '1');
...
-- ----------------------------
INSERT INTO shuijian_goods_type VALUES ('1', 'eeee', 'ee');
...
INSERT INTO shuijian_menu VALUES ('7', '客户管理', '1', '', '1', '0');
INSERT INTO shuijian_menu VALUES ('8', '产品管理', '1', '', '1', '0');
INSERT INTO shuijian_menu VALUES ('9', '客服系统', '1', '', '1', '0');
INSERT INTO shuijian_menu VALUES ('10', '商品管理', '1', '', '1', '0');
INSERT INTO shuijian_menu VALUES ('11', '订单管理', '1', '', '1', '0');
INSERT INTO shuijian_menu VALUES ('12', '采购管理', '1', '', '1', '0');
INSERT INTO shuijian_menu VALUES ('13', '大仓管理', '1', '', '1', '0');
INSERT INTO shuijian_menu VALUES ('14', '门店管理', '1', '', '1', '0');
INSERT INTO shuijian_menu VALUES ('15', '营销活动', '1', '', '1', '0');
INSERT INTO shuijian_menu VALUES ('16', '优惠券管理', '1', '', '1', '0');
INSERT INTO shuijian_menu VALUES ('17', '产品分类', '2', '/iadmin.php/Product/category', '1', '8');
INSERT INTO shuijian_menu VALUES ('18', '品类管理', '2', '/iadmin.php/Product/type', '1', '8');
INSERT INTO shuijian_menu VALUES ('19', '基础产品', '2', '/iadmin.php/Product/base', '1', '8');
INSERT INTO shuijian_menu VALUES ('20', '销售产品', '2', '/iadmin.php/Product/sale', '1', '8');
INSERT INTO shuijian_menu VALUES ('21', '物流管理', '2', '/iadmin.php/Deliver/deliver_list', '1', '1');
...
-- ----------------------------
-- Table structure for `shuijian_shopmap`
-- ----------------------------
DROP TABLE IF EXISTS `shuijian_shopmap`;
CREATE TABLE `shuijian_shopmap` (
  `shipAreaId` tinyint(3) NOT NULL auto_increment,
  `shopId` tinyint(3) NOT NULL,
  `labelInfo` varchar(60) character set utf8 NOT NULL,
  `lngAndLat` varchar(500) character set utf8 NOT NULL,
  `lngAndLatSize` varchar(500) character set utf8 NOT NULL,
  PRIMARY KEY  (`shipAreaId`)
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=latin1;

-- ----------------------------
-- Records of shuijian_shopmap
-- ----------------------------
INSERT INTO shuijian_shopmap VALUES ('6', '0', 'aaahhvd', '[[121.321648,31.205071],[121.323624,31.201271],[121.331637,31.200252],[121.33965,31.203897],[121.335338,31.211433],[121.319887,31.211155]]', '[121.33965,31.211433,121.319887,31.200252]');
...
-- ----------------------------
INSERT INTO shuijian_site VALUES ('1', '1', '0', '111', '11', '1', '13564128227', '01:00', '11:00', '1', '0', '0');
