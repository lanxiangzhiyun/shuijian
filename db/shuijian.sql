...
CREATE TABLE `shuijian_shopmap` (
  ...
  `labelInfo` varchar(60) NOT NULL,
  `lngAndLat` varchar(250) NOT NULL,
  `lngAndLatSize` varchar(120) CHARACTER SET utf8 NOT NULL,
...
-- ----------------------------
INSERT INTO `shuijian_shopmap` VALUES ('1', '0', 'test', '', '');
INSERT INTO `shuijian_shopmap` VALUES ('2', '0', 'ddd', '', '');
