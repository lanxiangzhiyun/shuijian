...
<html lang="en">
	<head>
		...
		<!-- ace styles -->
		<link rel="stylesheet" href="/newadmin20151119/Public/assets/css/ace.css" />

		<!--[if lte IE 9]>
			<link rel="stylesheet" href="/newadmin20151119/Public/assets/css/ace-part2.css" />
		<![endif]-->
		<link rel="stylesheet" href="/newadmin20151119/Public/assets/css/ace-rtl.css" />
...
$(function(){
	$('#reg').ajaxForm({
		beforeSubmit: checkFormreg, // 此方法主要是提交前执行的方法，根据需要设置
...
.loginnone{display:none;}
	...
	<body class="login-layout light-login">
										...
										<div class="widget-main">
											...
											<form  name="reg" id="reg" method="post" action="<?php echo U('reg');?>">
												<fieldset>
													...
													<label class="block clearfix">
														<span class="block input-icon input-icon-right">
															<input type="text" class="form-control" name="admin_username" id="admin_usernamereg"   placeholder="填写用户名" />
															<i class="ace-icon fa fa-user"></i>
														</span>
													</label>
													...
													<label class="block clearfix">
														<span class="block input-icon input-icon-right">
															<input type="password" class="form-control"  name="admin_pwd"  id="admin_pwdreg"  placeholder="填写密码" />
															<i class="ace-icon fa fa-lock"></i>
														</span>
													</label>
													...
													<label class="block clearfix">
														<span class="block input-icon input-icon-right">
															<input type="password" class="form-control"  name="admin_newpwd"  id="admin_newpwdreg"  placeholder="输入确认密码" />
		...
		<script type="text/javascript">
			window.jQuery || document.write("<script src='/newadmin20151119/Public/assets/js/jquery.js'>"+"<"+"/script>");
		</script>
