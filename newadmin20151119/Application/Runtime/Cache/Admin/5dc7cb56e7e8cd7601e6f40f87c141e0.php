      ...
      <script type="text/javascript" src="/newadmin20151119/Public/sldate/daterangepicker.js"></script>
               ...
               $(document).ready(function() {
                  $('#reservation').daterangepicker(null, function(start, end, label) {
					...
					<form name="admin_list_sea" class="form-search form-horizontal" method="post" action="/newadmin20151119/index.php/News/news_list">
...
function del(id,p){
	    ...
	    layer.close(index);
	    window.location.href="/newadmin20151119/index.php/News/news_list_del/n_id/"+id+"/p/"+p+"";//重新获取当前页面，删除后返回当前页码
	});
}
