							...
							<div class="col-xs-12">
                                ...
                                <input type="hidden" name="column_leftid" value="<?php echo ($column_leftid); ?>" />
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<script src="/newadmin/Public/ueditor/ueditor.config.js" type="text/javascript"></script>
                                            <script src="/newadmin/Public/ueditor/ueditor.all.js" type="text/javascript"></script>
