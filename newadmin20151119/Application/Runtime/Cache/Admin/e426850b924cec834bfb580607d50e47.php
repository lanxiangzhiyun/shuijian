								...
								<form class="form-horizontal" name="form0" id="form0" method="post" action="<?php echo U('news_runadd');?>"  enctype="multipart/form-data">
									...
									<div class="form-group">
										...
										<a href="javascript:;" class="file">
											...
											<span class="lbl">&nbsp;&nbsp;<img src="/newadmin20151119/Public/img/no_img.jpg" width="100" height="70" id="img0" ></span>&nbsp;&nbsp;<a href="javascript:;" onclick="return backpic('/newadmin20151119/Public/img/no_img.jpg');" title="还原修改前的图片" class="file">
                                            撤销上传
										</a>
...
<![endif]-->
		...
		<script src="/newadmin20151119/Public/assets/js/jquery.form.js"></script>
    		...
    		<!--下拉样式以及JS-->
		<link rel="stylesheet" href="/newadmin20151119/Public/assets/css/chosen.css" />
		<script src="/newadmin20151119/Public/assets/js/chosen.jquery.js"></script>
		<script type="text/javascript">
			jQuery(function($) {
				if(!ace.vars['touch']) {
