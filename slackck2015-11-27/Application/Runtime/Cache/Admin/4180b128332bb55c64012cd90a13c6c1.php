...
<?php if(is_array($data)): foreach($data as $key=>$v): ?><li class="<?php if(CONTROLLER_NAME == $v['name']): ?>active open<?php endif; ?>"><!--open代表打开状态-->
				...
				<div class="main-content-inner">
					<div class="page-content">
							...
							<div class="row maintop">
								...
								<a href="/slackck/index.php/Sys/admin_list_add">
								...
								<form name="admin_list_sea" class="form-search" method="post" action="/slackck/index.php/Sys/admin_list">
  ...
  <div class="input-group-btn">
  	<a href="/slackck/index.php/Sys/admin_list">
...
function del(id){
	...
	layer.close(index);
	window.location.href="/slackck/index.php/Sys/admin_list_del/admin_id/"+id+"";
	});
}
