...
<html lang="en">
	<head>
		...
		<script src="/newadmin/Public/assets/js/jquery.leanModal.min.js"></script>
			...
			<div class="main-content">
				<div class="main-content-inner">
					<div class="page-content">
						...
						<div class="row">
							<div class="col-xs-12">
								<form class="form-horizontal" name="admin_list_add" id="admin_list_add" method="post" action="/newadmin/index.php/Admin/Sys/admin_list_runadd">
...
<![endif]-->
		...
		<script src="/newadmin/Public/assets/js/jquery.form.js"></script>
    		...
    		<!--下拉样式以及JS-->
		<link rel="stylesheet" href="/newadmin/Public/assets/css/chosen.css" />
		<script src="/newadmin/Public/assets/js/chosen.jquery.js"></script>
		<script type="text/javascript">
			jQuery(function($) {
				if(!ace.vars['touch']) {
