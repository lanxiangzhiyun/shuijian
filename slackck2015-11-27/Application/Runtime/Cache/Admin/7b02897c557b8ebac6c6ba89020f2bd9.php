...
function del(id){
	    ...
	    layer.close(index);
	    window.location.href="/slackck/index.php/Plug/plug_linktype_del/id/"+id+"";
	});
}
...
<form class="form-horizontal" name="plug_linktype_edit" id="plug_linktype_edit" method="post" action="/slackck/index.php/Plug/plug_linktype_edit">
