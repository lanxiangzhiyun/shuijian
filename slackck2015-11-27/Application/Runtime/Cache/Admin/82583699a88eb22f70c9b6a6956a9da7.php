...
<!-- 点击模态框（Modal） -->
								...
								<form name="admin_list_sea" class="form-search" method="post" action="/slackck/index.php/Plug/plug_link_list">
								  ...
								  <div class="input-group-btn">
									<a href="/slackck/index.php/Plug/plug_link_list">
							...
							<div class="row maintop">
								...
								<?php if(is_array($link_type)): foreach($link_type as $key=>$v): ?><a href="/slackck/index.php/Plug/plug_link_list/type/<?php echo ($v["plug_linktype_id"]); ?>">
									<button class="btn btn-xs btn-warning">
...
<form class="form-horizontal" name="plug_link_add" id="plug_link_add" method="post" action="/slackck/index.php/Plug/plug_link_runadd">
...
<form class="form-horizontal" name="plug_link_runedit" id="plug_link_runedit" method="post" action="/slackck/index.php/Plug/plug_link_runedit">
...
function del(id,p){
	...
	layer.close(index);
	window.location.href="/slackck/index.php/Plug/plug_link_del/plug_link_id/"+id+"/p/"+p+"";
	});
}
