										...
										<div>
											<table id="dynamic-table" class="table table-striped table-bordered table-hover">
												...
												<div class="hidden-sm hidden-xs action-buttons">
													<a class="green" href="/slackck/Public/soft/chrome.rar" title="下载软件">
													...
													<tr>
													  ...
													  <td>
													  <div class="hidden-sm hidden-xs action-buttons">
													  <a class="green" href="/slackck/Public/soft/winrar.exe" title="下载软件">
...
function del(id){
	    ...
	    layer.close(index);
	    window.location.href="/slackck/index.php/Help/leftnavdel/adminnav_id/"+id+"";
	});
}
