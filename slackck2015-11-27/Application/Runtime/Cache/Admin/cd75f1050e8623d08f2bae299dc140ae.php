...
<form class="form-horizontal" name="we_menu_runadd" id="we_menu_runadd" method="post" action="/slackck/index.php/We/we_menu_runadd">
...
<form class="form-horizontal" name="we_menu_runedit" id="we_menu_runedit" method="post" action="/slackck/index.php/We/we_menu_runedit">
...
function del(id){
	...
	layer.close(index);
	window.location.href="/slackck/index.php/We/we_menu_del/we_menu_id/"+id+"";
	});
}
