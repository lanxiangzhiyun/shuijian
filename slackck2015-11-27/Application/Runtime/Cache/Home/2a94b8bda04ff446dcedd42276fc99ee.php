...
<form class="regi" name="addtel" id="addtel" method="post" action="/newadmin/index.php/Home/Index/addtel">
         <div class="modal-body">

<span>填写手机号码，方便中奖后联系您</span>
...
$(function(){
	...
	function complete(data){
		if(data.status==1){
			layer.alert('保存成功，进入答题', {icon: 6}, function(index){
 			layer.close(index);
