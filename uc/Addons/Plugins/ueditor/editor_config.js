...
(function () {
    ...
    var tmp = window.location.pathname;
        URL = window.UEDITOR_HOME_URL|| '/Addons/Plugins/ueditor/';
		//URL = window.UEDITOR_HOME_URL || '/bbs/Addons/Plugins/ueditor/'.substr(0,'/bbs/Addons/Plugins/ueditor/'.lastIndexOf("\/")+1).replace("_examples/","").replace("website/","");//这里你可以配置成ueditor目录在您网站的相对路径或者绝对路径（指以http开头的绝对路径）
    ...
    window.UEDITOR_CONFIG = {
		...
		,imageUrl:URL.replace('Addons/Plugins/ueditor/','index.php/Upload/bdImageUpload') //图片上传提交地址
		//,imageUrl:URL.replace('Addons/Plugins/ueditor/','imageUp.php/imgUpload') //图片上传提交地址
        //,imagePath:URL + "php/"                     //图片修正地址，引用了fixedImagePath,如有特殊需求，可自行配置
		,imagePath:URL.replace('Addons/Plugins/ueditor/','')
        ...
        //附件上传配置区
		//,fileUrl:URL.replace('Addons/Plugins/ueditor/','index.php/forums/fileUpload') //附件上传提交地址
        //,fileUrl:URL+"php/fileUp.php"               //附件上传提交地址
        //,filePath:URL + "php/"                   //附件修正地址，同imagePath
		//,filePath:URL.replace('Addons/Plugins/ueditor/','')
        //,fileFieldName:"upfile"                    //附件提交的表单名，若此处修改，需要在后台对应文件修改对应参数

         //远程抓取配置区
        //,catchRemoteImageEnable:true               //是否开启远程图片抓取,默认开启
        //,catcherUrl:URL.replace('Addons/Plugins/ueditor/','index.php/forums/imgRemoteGet')   //处理远程图片抓取的地址
        //,catcherPath:URL + "php/"                  //图片修正地址，同imagePath
		//,catcherPath:URL.replace('Addons/Plugins/ueditor/','')
		...
		//,imageUrl:URL.replace('Addons/Plugins/ueditor/','index.php/forums/imgUpload') //图片上传提交地址
		...
		//,snapscreenServerUrl: URL.replace('Addons/Plugins/ueditor/','index.php/Upload/bdImageUpload')
        //,snapscreenPath: URL + "php/"
		//,snapscreenPath:URL.replace('Addons/Plugins/ueditor/','')
		...
		//,wordImageUrl:URL.replace('Addons/Plugins/ueditor/','index.php/forums/imgUpload')
        //,wordImagePath:URL + "php/"                       //
		//,wordImagePath:URL.replace('Addons/Plugins/ueditor/','')
        ...
        ,initialStyle:'body{font-family:\'arial\';font-size:16px}'   //编辑器内部样式,可以用来改变字体等
