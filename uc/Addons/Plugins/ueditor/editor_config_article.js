...
(function () {
    ...
    window.UEDITOR_CONFIG = {
		...
		,imageUrl:URL.replace('Addons/Plugins/ueditor/','iadmin.php/Upload/bkArticleImageUpload') //图片上传提交地址
        ...
        ,initialStyle:'body{font-family:\'arial\';font-size:14px}'   //编辑器内部样式,可以用来改变字体等
