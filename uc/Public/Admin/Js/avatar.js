function loadAvatar(d,p,a,s,f,type,w,h){
		...
		function rDom () {
				var emoTion = [];
				emoTion.push('<div id="allBox"><div id="picBox"><div id="picViewOuter">图片载入中……</div>');
		...
		*/
		...
		getID('picViewOuter').innerHTML = '<table id="picMask" border="0" cellspacing="0" cellpadding="0"><tr><td id="pP">&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td></tr><tr><td>&nbsp;</td><td id="pO"><div id="pC"></div></td><td>&nbsp;</td></tr><tr><td height="280">&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td></tr></table><img src="' + _imgPath + '?' + new Date().getTime() + '" border="0" id="sourceimg" />';
		...
		function dragsChange(e, k,t) {  //拖拽区域框
			...
			document.onmousemove = function(e) {
				...
				try {
					eval(chkSize('X', 'W', 'L', 'width', 'left', 0, 2, 940));
				} catch(err) {}
				try {
					eval(chkSize('Y', 'H', 'T', 'height', 'top', 1, 3, 430));
				} catch(err) {}
		...
		getID('sliderBlock').onmousedown = function(e) {   //缩放滚动条
			var e = window.event || e;
			var _scrO = this;
