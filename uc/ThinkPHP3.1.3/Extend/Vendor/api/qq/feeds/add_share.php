...
function add_share($appid, $appkey, $access_token, $access_token_secret, $openid, $post_data){
	//发布一条动态的接口地址, 不要更改!!
    $url    = "http://openapi.qzone.qq.com/share/add_share";
	return do_post($url, $appid, $appkey, $access_token, $access_token_secret, $openid, $post_data);
}
