...
<script type="text/javascript">
	...
	document.write(unescape("%3Cscript src='" + _bdhmProtocol + "hm.baidu.com/h.js%3Ff54ce27e8176cc54729be9120232a540' type='text/javascript'%3E%3C/script%3E"));
</script>
<?
gotoUrl("http://clocal.boqii.com/ThinkPHP/Extend/Vendor/api/qq/user/get_user_info.php?callback=".$callback);
