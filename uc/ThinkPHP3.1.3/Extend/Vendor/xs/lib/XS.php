 ...
 * 
 * 切勿手动修改本文件！生成时间：2013/02/21 11:19:01 
 *
 * @author hightman
...
class XSIndex extends XSServer
{
	...
	public function flushIndex()
	{
		...
		{
			error_log($e->getCode(),3,C('PHP_VET_LOG_DIR').'xs.log');
			error_log('CMD_ERR_BUSY:>>'.CMD_ERR_BUSY,3,C('PHP_VET_LOG_DIR').'xs.log');
			error_log('CMD_ERR_RUNNING:>>'.CMD_ERR_RUNNING,3,C('PHP_VET_LOG_DIR').'xs.log');
