        ...
        try{
            ...
            if($method->isPublic()) {
                ...
                if(C('URL_PARAMS_BIND') && $method->getNumberOfParameters()>0){
					...
					//$result = setcookie('boqii_auth_779', 5241, (time()+3600*24*90), '/', '.boqii.com', $_SERVER['SERVER_PORT'] == 443 ? 1 : 0);
                }else{
					//$result = setcookie('boqii_auth_777', 5240, (time()+3600*24*90), '/', '.boqii.com', $_SERVER['SERVER_PORT'] == 443 ? 1 : 0);
					//var_dump($result);
					//print_r($module);
                    $method->invoke($module);
					//$result = setcookie('boqii_auth_777', 5239, (time()+3600*24*90), '/', '.boqii.com', $_SERVER['SERVER_PORT'] == 443 ? 1 : 0);
					//var_dump($result);
                }
                // 后置操作
